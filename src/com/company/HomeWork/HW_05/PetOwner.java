...
class Cat {
    ...
    public Cat(String name1, int age1, Woman owner) {
        this.name1 = name1;
        this.age1 = age1;
        this.owner = owner;
    }
    ...
    class Dog1 {
        ...
        public Dog1(String name1, int age1, Woman owner) {
            this.name1 = name1;
            this.age1 = age1;
            this.owner = owner;
        }
        ...
        class Fish {
            ...
            public Fish(String name1, int age1, Woman owner) {
                this.name1 = name1;
                this.age1 = age1;
                this.owner = owner;
            }
